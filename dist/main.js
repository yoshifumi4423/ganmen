...
var _StyledComponent = (function (ComponentStyle, constructWithOptions) {
  ...
  var createStyledComponent = function createStyledComponent(target, options, rules) {
    ...
    if (isClass) hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_5___default()(StyledComponent, target);
...
var fetchLike = exports.fetchLike = function fetchLike(imageId) {
...
var fetchSkip = exports.fetchSkip = function fetchSkip(imageId) {
...
var Image = _styledComponents2.default.div(_templateObject);
...
var Images = function (_React$Component) {
  ...
  _createClass(Images, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _api.fetchImages)().then(function (json) {
        _this2.setState({ images: json.images });
      });
    }
  }, {
    key: "removeImage",
    value: function removeImage(imageId) {
      var newImages = this.state.images.filter(function (image) {
    ...
    key: "fetchMoreImages",
    value: function fetchMoreImages() {
      var _this3 = this;

      if (this.state.images.length > 5) return;

      (0, _api.fetchImages)().then(function (json) {
        _this3.setState({ images: json.images });
      });
    }
  }, {
    key: "like",
    value: function like(imageId) {
      var _this4 = this;

      (0, _api.fetchLike)(imageId).then(function (json) {
        if (json.result) {
          console.log("LIKE 成功");
          _this4.removeImage(imageId);
          _this4.fetchMoreImages();
        } else {
          console.log("LIKE 失敗");
        }
      });
    ...
    key: "skip",
    value: function skip(imageId) {
      var _this5 = this;

      (0, _api.fetchSkip)(imageId).then(function (json) {
        if (json.result) {
          console.log("SKIP 成功");
          _this5.removeImage(imageId);
          _this5.fetchMoreImages();
        } else {
          console.log("SKIP 失敗");
        }
      });
        ...
        this.state.images.map(function (image) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              Image,
              null,
              _react2.default.createElement("img", { src: image.filename })
            )
          );
        })
      );
...
var _Images = __webpack_require__(/*! ./components/Images */ "./src/components/Images.js");

var _Images2 = _interopRequireDefault(_Images);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_Images2.default, null), document.getElementById("images"));
